      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Visit our head office in Lusaka or contact us to arrange a meeting
          </p>
        </div>
        
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="bg-[#f5f5f5] p-8 rounded-lg">
            <h3 className="text-2xl font-bold text-[#0a192f] mb-6">Head Office Location</h3>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Plot 123, Independence Avenue<br/>Lusaka, Zambia</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">+260 211 123 456</p>
                </div>
              </div>
              <div className="flex items-start">
          ...
          <div className="h-96 rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3846.123456789!2d28.2816!3d-15.4167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTXCsDI1JzAwLjAiUyAyOMKwMTYnNTQuMCJF!5e0!3m2!1sen!2szm!4v1234567890123"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Calm Mountain Properties Location"
            ></iframe>
          </div>
        </div>
      </div>
